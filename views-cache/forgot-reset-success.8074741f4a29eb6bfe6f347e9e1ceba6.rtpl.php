...
<div class="lockscreen-wrapper">
  <div class="lockscreen-logo">
    <a href="/ecommercee/res/admin/index2.html"><b>Admin</b>LTE</a>
  </div>
  ...
  <div class="help-block text-center">
    <div class="callout callout-success">
      ...
      <p>Tente fazer o login com sua nova senha.<br><a href="/ecommercee/admin/login">Clique aqui</a> para fazer o login.</p>
    </div>
  </div>
  <div class="lockscreen-footer text-center">
    Copyright &copy; 2014-2016 <b><a href="http://localhost:83/ecommercee/" class="text-black">Caike's Store</a></b><br>
    All rights reserved
  </div>
</div>
<!-- /.center -->
